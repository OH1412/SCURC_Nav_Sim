...
#ifndef ELEVATION_MAP_MSGS__SRV__DETAIL__CHECK_SAFETY__FUNCTIONS_H_
#define ELEVATION_MAP_MSGS__SRV__DETAIL__CHECK_SAFETY__FUNCTIONS_H_
...
/// Initialize srv/CheckSafety message.
/**
 ...
 * )) before or use
 * elevation_map_msgs__srv__CheckSafety_Request__create()
...
/// Finalize srv/CheckSafety message.
/**
...
/// Create srv/CheckSafety message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * elevation_map_msgs__srv__CheckSafety_Request__init().
...
/// Destroy srv/CheckSafety message.
/**
 * It calls
 * elevation_map_msgs__srv__CheckSafety_Request__fini()
...
/// Check for srv/CheckSafety message equality.
/**
...
/// Copy a srv/CheckSafety message.
/**
...
/// Initialize array of srv/CheckSafety messages.
/**
...
/// Finalize array of srv/CheckSafety messages.
/**
 * It calls
 * elevation_map_msgs__srv__CheckSafety_Request__fini()
...
/// Create array of srv/CheckSafety messages.
/**
 * It allocates the memory for the array and calls
 * elevation_map_msgs__srv__CheckSafety_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CheckSafety messages.
/**
 * It calls
 * elevation_map_msgs__srv__CheckSafety_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CheckSafety message array equality.
/**
...
/// Copy an array of srv/CheckSafety messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * elevation_map_msgs__srv__CheckSafety_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_elevation_map_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * elevation_map_msgs__srv__CheckSafety_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_elevation_map_msgs
...
/**
 * It calls
 * elevation_map_msgs__srv__CheckSafety_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_elevation_map_msgs
...
/**
 * It allocates the memory for the array and calls
 * elevation_map_msgs__srv__CheckSafety_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_elevation_map_msgs
...
/**
 * It calls
 * elevation_map_msgs__srv__CheckSafety_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ELEVATION_MAP_MSGS__SRV__DETAIL__CHECK_SAFETY__FUNCTIONS_H_
