#!/usr/bin/env python3
"""Static TF broadcaster: publish a fixed transform from parent (odom) to child (base_link).

Reads parameters (defaults):
  - odom_frame_id (parent) default: "odom"
  - base_frame_id (child) default: "base_link"
...
class StaticTFNode(Node):
    def __init__(self, initial_transforms=None):
        ...
        # Example element: {odom_frame_id: 'odom', base_frame_id: 'base_link', translation: {x:0,y:0,z:0}, rotation_rpy: [0,0,0]}
