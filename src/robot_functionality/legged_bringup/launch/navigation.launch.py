...
def generate_launch_description():
    ...
    load_composable_nodes = OpaqueFunction(function=_composable_nodes_action)
    ...
    get_package_share_directory('legged_bringup'), 'rviz', 'nav2_default_view.rviz')
    start_rviz = Node(
        package='rviz2',
        executable='rviz2',
    ...
    #     get_package_share_directory('legged_waypoint_loader_cpp'),
    #     'config',
    #     'waypoints.yaml'
    # )

    # waypoint_loader_node = Node(
    #     package='legged_waypoint_loader_cpp',
