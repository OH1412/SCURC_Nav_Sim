...
def generate_launch_description():
    ...
    pkg_behavior_ext = get_package_share_directory("behavior_ext_plugins")
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[
                nav2_params_path,
                {
                    "bt_xml_filename": control_height_bt_path,  # 仅指向control_height的BT文件
                    "plugin_lib_names": ["behavior_ext_plugins_lib"],  # 仅加载control_height插件
                    "default_bt_xml_filename": control_height_bt_path  # 强制默认使用control_height BT
                }
            ],
            additional_env={
